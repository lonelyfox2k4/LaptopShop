 ...
 */
@MultipartConfig()
@WebServlet(name="InforAdmin", urlPatterns={"/inforAdmin"})
public class InforAdmin extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InforAdmin</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InforAdmin at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("inforAdmin.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (check.equals("png") || check.equals("jpg")) {
                ...
                response.sendRedirect("inforAdmin");
            }
