<%-- 
    Document   : loginAdmin
    Created on : Mar 6, 2024, 3:05:10 PM
    Author     : admin
--%>
...
<html>
    <head>
        ...
        <title>JSP Page</title><link href="//maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
    ...
    <body>
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <div id="formFooter">
                    <a href="changex">Change Password</a>
                </div>
            </div>
        </div>
    </body>
