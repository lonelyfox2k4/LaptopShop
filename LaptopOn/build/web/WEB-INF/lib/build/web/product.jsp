<%-- 
    Document   : product
    Created on : Feb 19, 2024, 4:41:15 PM
    Author     : admin
--%>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item " style="display: flex">
                            <a class="nav-link" href="product?hang=0">All <span class="sr-only">(current)</span></a>
            ...
            <div class="row">
                <div class="col-md-3" style="margin-top: 20px">
                    <form action="product" method="get">
                        ...
                        <span class="big_title">NĂM SẢN XUẤT</span>
                        <div class="option__list ">
                            <div class="form-group">
                                <select id="inputState" class="form-control" name="nam">
                                    <option value="0" ${requestScope.nsx == 0?"selected":""}>All</option>
                                    <c:forEach items="${requestScope.nam}" var="nam">
                                        <option value="${nam}" ${requestScope.nsx == nam?"selected":""}> ${nam} </option>
                                    </c:forEach>
                                </select>
                            </div>  
                        </div>
                    ...
                    <div id="wp-products">
                        ...
                        <div class="list-page">
                            <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                                <a href="product?page=${i}&${key}"><div class="item" style="color: white;">${i}</div></a>
                                </c:forEach>
                        </div>
                    </div>
                </div>    
