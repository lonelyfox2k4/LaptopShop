<%-- 
    Document   : addProduct
    Created on : Mar 8, 2024, 11:02:18 AM
    Author     : admin
--%>
        ...
        <div id="main" >
            ...
            <div class="container">
                <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                    <div class="row">
                        <div class="col-12">
                            <h2 style="color: red" class="tm-block-title d-inline-block">Add Product</h2>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12 row">
                                    <div class="col-md-6" style="color: white;">
                                        <div class="form-group mb-3">
                                            ...
                                            <input value="${p.id}"  name="id" type="text" class="form-control validate" >
                                        </div>
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input value="${p.describe}" type="text" name="mota" class="form-control validate" style="padding: 20px;" required=""></input>
                                        </div>

                                        <div class="row">
                                            <div class="form-group mb-3" style="    margin-left: 14px;">
                                                <label for="mota">Giá tiền</label>
                                                <input value="${p.prices}" name="price" type="number" class="form-control validate" required=""></input>
                                            </div>
                                            <div class="form-group mb-3" style="    margin-left: 95px;">
                                                <label for="mota">Sale (Không bắt buộc)</label>
                                                <input value="${0}" name="sale" type="number" class="form-control validate" required=""></input>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="mota">Năm sản xuất (Không bắt buộc)</label>
                                            <input value="${0}" name="nsx" type="number" class="form-control validate" required=""></input>
                                        </div>
                                    </div>
                                        ...
                                        <div class="custom-file mt-3 mb-3">
                                            <div style="text-align: center; margin-top: 30px">
                                                <div style="text-align: center; margin-top: 30px">
                                                    ...
                                                    <input type="file" class="form-control" name="photo" placeholder="Enter photo" style="color: black" required="">
                                                </div>
                                            </div>
                                            <div class="form-group mb-3">
                                ...
                                <div class="col-md-12 row">
                                    <div class="col-md-6" style="color: white;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group mb-3" style="    margin-left: 95px;">
                                                <label for="mota">Sale (Không bắt buộc)</label>
                                                <input value="${p.sale}" name="sale" type="number" class="form-control validate" required=""></input>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="mota">Năm sản xuất (Không bắt buộc)</label>
                                            <input value="${p.nsx}" name="nsx" type="number" class="form-control validate" required=""></input>
                                        </div>
                                    </div>
