<%-- 
    Document   : inforAdmin
    Created on : Mar 6, 2024, 3:32:56 PM
    Author     : admin
--%>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div class="col-div-12">
                ...
                <form action="inforAdmin" method="post" enctype="multipart/form-data">
                    <div class="row" style="margin-top: 20px; border-bottom: solid 1px #ece4e4; ">
                                    ...
                                    <td class="Tmj5Z6">
                                        <div>
                                            <div class="W50dp5" style="margin-left: 10px"><input style="    border: none;
                                                                                                 ...
                                                                                                 color: white;
                                                                                                 font-family: auto;
                                                                                                 font-size: 18px;" type="text" name="email" readonly="" value="${admin.email}"></div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="Tmj5Z6">
                                        <div>
                                            <div class="W50dp5" style="margin-left: 10px">${admin.fullname}</div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="Tmj5Z6">
                                        <div>
                                            <div class="W50dp5" style="margin-left: 10px">${admin.phone}</div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-md-4" >
                            <div style="text-align: center; margin-top: 30px">
                                <img src="${admin.img}" alt="alt" style="width: 150px; border-radius: 100px; margin-bottom: 20px"/>
                                <h2 style="font-family: auto; font-size: 18px; color: white">Vui lòng file có kết thúc bằng .jpg hoặc .png</h2>
                                <input type="file" class="form-control" name="photo" placeholder="Enter photo" style="color: white" value="${requestScope.link}" required="">
                            </div>
                        </div>
                        <div>
